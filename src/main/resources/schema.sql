...
CREATE TABLE IF NOT EXISTS users(
    ...
    CONSTRAINT fk_users_profile FOREIGN KEY (profile_id) REFERENCES binary_content(id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS message_attachments(
    ...
    PRIMARY KEYe (message_id, attachment_id),
    CONSTRAINT fk_message_attachments_message FOREIGN KEY (message_id) REFERENCES messages(id) ON DELETE CASCADE,
    CONSTRAINT fk_message_attachments_attachment FOREIGN KEY (attachment_id) REFERENCES binary_content(id) ON DELETE CASCADE
);